...
// pasó a $80 (jul 2026) y luego a €65 (ago 2026) —además cambiando de moneda—
// pero el valor del enum se conserva para no migrar la BD (columna price_tier en
// 0001_init.sql). El monto real lo fija el Price de Stripe, no este nombre; el
// enum es solo un bucket que mapea Price ID ↔ fila de la BD.
